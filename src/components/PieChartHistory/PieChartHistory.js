...
const PieChartHistory = ({trips, user}) => {
  ...
  return (
    ...
    <div className="headingTripHistory" style={{backgroundColor: '#395571', padding: '3px'}}>
      <h1 style={{color: 'white', paddingLeft: '50px', paddingTop: '5px', fontSize: '60px'}}>Trip History</h1>
    ...
    <div className="organiserBtn">
      ...
      <h1 className="bigTitle" style={{paddingRight: '30px'}}>Where I'm Organiser</h1>
